			...
			<div>
				<table class="col-md-11" id="transactionTable">
					...
					<tr>
						...
						<th onclick="sortTable(1, 'transactionTable')">User Name:</th>
						<th onclick="sortTable(2, 'transactionTable')">Inventory ID</th>
						<th onclick="sortTable(3, 'transactionTable')">Rack ID</th>
						<th onclick="sortTable(4, 'transactionTable')">Bin ID</th>
						<th onclick="sortTable(5, 'transactionTable')">Type</th>
						<th onclick="sortTable(6, 'transactionTable')">Quantity</th>
					</tr>
