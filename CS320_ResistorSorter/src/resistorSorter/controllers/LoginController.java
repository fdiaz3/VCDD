...
public class LoginController {
	...
	public void userRequestAdmin(String email){
			...
			String message = "Hello creators of the VCDD, this is your automated email sending unit up and running (hopefully). \n"
					...
					+"Click here to grant: \n"
					+"http://localhost:8081/resistorSorter/AdminRequest?email="+email+"&adminReq=true&uuid="+uuid+"\n"
					+"http://calientecraft.org:8081/resistorSorter/AdminRequest?email="+email+"&adminReq=true&uuid="+uuid+"\n"
					+"Click here to revoke: \n"
					+"http://localhost:8081/resistorSorter/AdminRequest?email="+email+"&adminReq=false&uuid="+uuid+"\n"
					+"http://calientecraft.org:8081/resistorSorter/AdminRequest?email="+email+"&adminReq=false&uuid="+uuid+"\n";
